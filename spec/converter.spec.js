...
describe('Normal Converter', () => {
    describe('Negative tests', () => {
        it('recognizes too few arguments', done => {
            cp.exec('node src/convert.js 5 m to', (err, stdout) => {
        ...
        it('recognizes invalid number', done => {
            cp.exec('node src/convert.js foo m to mm', (err, stdout) => {
                expect(stdout).toBe(errorMessage);
                done();
            });
        });
        ...
        it('recognizes unknown from-unit', done => {
            cp.exec('node src/convert.js 5 x to mm', (err, stdout) => {
                expect(stdout).toBe(errorMessage);
                done();
            });
        });
        ...
        it('recognizes unknown to-unit', done => {
            cp.exec('node src/convert.js 5 m to x', (err, stdout) => {
                expect(stdout).toBe(errorMessage);
                done();
            });
        });
        ...
        it('recognizes missing "to" constant', done => {
            cp.exec('node src/convert.js 5 m too mm', (err, stdout) => {
                expect(stdout).toBe(errorMessage);
                done();
            });
        });
    ...
    describe('Positive tests', () => {
        it('can convert length', done => {
            cp.exec('node src/convert.js 5 m to cm', (err, stdout) => {
        ...
        it('can convert weight', done => {
            cp.exec('node src/convert.js 5000 g to kg', (err, stdout) => {
        ...
        it('can convert floats', done => {
            cp.exec('node src/convert.js 5.5 kg to g', (err, stdout) => {
        ...
        it('can convert unit into itself', done => {
            cp.exec('node src/convert.js 5 m to m', (err, stdout) => {
